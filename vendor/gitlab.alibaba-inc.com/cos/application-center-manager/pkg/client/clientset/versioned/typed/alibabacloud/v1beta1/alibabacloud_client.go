...
import (
	...
	"gitlab.alibaba-inc.com/cos/application-center-manager/pkg/client/clientset/versioned/scheme"
...
// AppV1beta1Client is used to interact with features provided by the app.alibabacloud.com group.
type AppV1beta1Client struct {
	restClient rest.Interface
}

func (c *AppV1beta1Client) Canaries(namespace string) CanaryInterface {

...
import (
	...
	alibabacloudv1beta1 "gitlab.alibaba-inc.com/cos/application-center-manager/pkg/apis/alibabacloud/v1beta1"
	versioned "gitlab.alibaba-inc.com/cos/application-center-manager/pkg/client/clientset/versioned"
	internalinterfaces "gitlab.alibaba-inc.com/cos/application-center-manager/pkg/client/informers/externalversions/internalinterfaces"
	v1beta1 "gitlab.alibaba-inc.com/cos/application-center-manager/pkg/client/listers/alibabacloud/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppV1beta1().Canaries(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppV1beta1().Canaries(namespace).Watch(options)
			},
		},
		&alibabacloudv1beta1.Canary{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *canaryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&alibabacloudv1beta1.Canary{}, f.defaultInformer)
}

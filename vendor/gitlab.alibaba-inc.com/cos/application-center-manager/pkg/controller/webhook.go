...
func CallWebhook(name string, namespace string, phase appv1beta1.CanaryPhase, w appv1beta1.CanaryWebhook) error {
	payload := appv1beta1.CanaryWebhookPayload{
		Name:      name,
		Namespace: namespace,
		Phase:     phase,
	}
...
func CallEventWebhook(r *appv1beta1.Canary, webhook, message, eventtype string) error {

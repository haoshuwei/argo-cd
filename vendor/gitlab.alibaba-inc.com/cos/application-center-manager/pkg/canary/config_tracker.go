...
func (ct *ConfigTracker) GetTargetConfigs(cd *appv1beat1.Canary) (map[string]ConfigRef, error) {
...
func (ct *ConfigTracker) GetConfigRefs(cd *appv1beat1.Canary) (*map[string]string, error) {
...
func (ct *ConfigTracker) HasConfigChanged(cd *appv1beat1.Canary) (bool, error) {
	configs, err := ct.GetTargetConfigs(cd)
	if err != nil {
...
func (ct *ConfigTracker) CreatePrimaryConfigs(cd *appv1beat1.Canary, refs map[string]ConfigRef) error {

...
// NewRepoCredsCommand returns a new instance of an `appcenter repocreds` command
...
// NewRepoCredsAddCommand returns a new instance of an `appcenter repocreds add` command
func NewRepoCredsAddCommand(clientOpts *argocdclient.ClientOptions) *cobra.Command {
  ...
  appcenter repocreds add https://git.example.com/repos/ --username git --password secret

  # Add credentials with SSH private key authentication to use for all repositories under ssh://git@git.example.com/repos
  appcenter repocreds add ssh://git@git.example.com/repos/ --ssh-private-key-path ~/.ssh/id_rsa
`
...
// NewRepoCredsRemoveCommand returns a new instance of an `appcenter repocreds rm` command
...
// NewRepoCredsListCommand returns a new instance of an `appcenter repo list` command
